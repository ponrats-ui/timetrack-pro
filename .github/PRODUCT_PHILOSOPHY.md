...
Accounting language second.

Natural language first.

Technical language second.

Use words that owners use in the real world. Prefer clear explanations over
professional jargon.

## Simplicity

Simple does not mean small. Simple means unnecessary decisions have been
removed.

If users need a manual for a common workflow, redesign the workflow.
